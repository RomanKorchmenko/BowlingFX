...
/*SF_DATA;ver:0.17;sub:START;pass:START;ps:lgpr:1,nrmq:1,limd:3,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,uamb:True,mssp:True,ufog:True,aust:True,igpj:False,qofs:0,lico:1,qpre:1,flbk:,rntp:1,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,hqsc:True,hqlp:False,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300;n:type:ShaderForge.SFN_Final,id:0,x:32149,y:32542|diff-138-R,spec-145-OUT,gloss-146-OUT,normal-123-RGB;n:type:ShaderForge.SFN_Tex2d,id:123,x:32520,y:32881,ptlb:Normal,tex:bbab0a6f7bae9cf42bf057d8ee2755f6,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:138,x:33117,y:32453,ptlb:Diffuse,tex:b66bceaf0cc0ace4e9bdc92f14bba709,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:144,x:32679,y:32783,ptlb:Gloss,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Slider,id:145,x:32536,y:32579,ptlb:Specular,min:0,cur:0.3157895,max:1;n:type:ShaderForge.SFN_Multiply,id:146,x:32520,y:32704|A-147-OUT,B-144-OUT;n:type:ShaderForge.SFN_Power,id:147,x:32692,y:32641|VAL-138-R,EXP-148-OUT;n:type:ShaderForge.SFN_Vector1,id:148,x:32869,y:32689,v1:2;proporder:123-138-144-145;pass:END;sub:END;*/
...
////// Specular:
                ...
                float3 finalColor = diffuse * float3(node_138.r,node_138.r,node_138.r) + specular;
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_156.rg, _Normal))).rgb;
                float3 normalDirection = normalize( mul( normalLocal, tangentTransform ) );
...
///////// Gloss:
                float4 node_138 = tex2D(_Diffuse,TRANSFORM_TEX(node_156.rg, _Diffuse));
                float gloss = exp2((pow(node_138.r,2.0)*_Gloss)*10.0+1.0);
////// Specular:
                NdotL = max(0.0, NdotL);
                float _Specular_var = _Specular;
