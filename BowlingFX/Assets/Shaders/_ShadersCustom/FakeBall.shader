...
_cubeAmmount("_cubeAmmount", Range(0,10) ) = 0.5
_fresnel("_fresnel", Range(0,10) ) = 0.5
_powcolor("_powcolor", Color) = (1,1,1,1)
...
float4 Multiply1=TexCUBE0 * Tex2D0;
float4 Multiply0=Multiply1 * _cubeAmmount.xxxx;
...
float4 Multiply3=Pow1 * _powcolor;
